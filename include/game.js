/* 
   ...
   Author: Zongrui Liu
   Usage: JavaScript for the Breakout game, including canvas rendering,
   ball and paddle movement, brick collisions, score tracking, pause/restart
...
function submitScore(finalScore) {
  ...
  fetch("include/submit_score.php", {
    ...
    localStorage.setItem(
      "breakout_leaderboard",
      JSON.stringify(lb.slice(0, 50)),
    );
  });
}
